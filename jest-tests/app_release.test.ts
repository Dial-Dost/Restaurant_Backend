import { APP_RELEASE, resolveAppRelease } from "../app_release.js";
...
describe("app release manifest", () => {
	const KEYS = ["APP_LATEST_VERSION", "APP_MIN_VERSION", "APP_UPDATE_NOTES",
		"APP_DOWNLOAD_WINDOWS", "APP_DOWNLOAD_ANDROID", "APP_DOWNLOAD_IOS"] as const;
	...
	test("env still wins, field by field — the incident escape hatch", () => {
	...
	test("a blank or whitespace env var is treated as unset, not as an empty release", () => {
		...
		process.env.APP_DOWNLOAD_WINDOWS = "   ";
