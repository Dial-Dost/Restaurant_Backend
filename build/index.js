...
async function requireAuth(req, res, next) {
    ...
    const normalizedRole = (_a = normalizeRole(session.role)) !== null && _a !== void 0 ? _a : "employee";
    ...
    req.auth = {
        ...
        features: (_b = session.features) !== null && _b !== void 0 ? _b : {},
        limits: (_c = session.limits) !== null && _c !== void 0 ? _c : {},
        allOutlets,
    };
...
const allowedOrigins = new Set([
    ...
    ...((_b = (_a = process.env.ALLOWED_ORIGINS) !== null && _a !== void 0 ? _a : process.env.EXTRA_CORS_ORIGINS) !== null && _b !== void 0 ? _b : "")
        .split(",")
        .map((o) => o.trim())
        .filter((o) => o.length > 0),
]);
...
app.use(express.json({
    ...
    verify: (req, _res, buf) => {
        var _a;
        if (((_a = req.url) !== null && _a !== void 0 ? _a : "").startsWith("/webhooks/")) {
...
app.use((req, res, next) => {
    var _a, _b;
    const features = ((_b = (_a = req.auth) === null || _a === void 0 ? void 0 : _a.features) !== null && _b !== void 0 ? _b : {});
...
let realtimeServerPromise = null;
...
async function bootstrap() {
    ...
    const exceptionSweepTimer = setInterval(() => void exceptionSweep(), 30 * 60000);
    (_a = exceptionSweepTimer.unref) === null || _a === void 0 ? void 0 : _a.call(exceptionSweepTimer);
    ...
    if (process.env.REPORT_SCHEDULER === "true") {
        const reportSweepTimer = setInterval(() => void reportSweep(), Math.max(1, Number(process.env.REPORT_SWEEP_INTERVAL_MIN) || 5) * 60000);
        (_b = reportSweepTimer.unref) === null || _b === void 0 ? void 0 : _b.call(reportSweepTimer);
    ...
    if (process.env.PRINT_JOB_REAPER !== "false") {
        ...
        const printReaperTimer = setInterval(() => void printReaperSweep(), Math.max(1, Number(process.env.PRINT_JOB_REAPER_INTERVAL_MIN) || 15) * 60000);
        (_c = printReaperTimer.unref) === null || _c === void 0 ? void 0 : _c.call(printReaperTimer);
    ...
    if (process.env.PRINT_ROUTING !== "false") {
        ...
        const printOrphanTimer = setInterval(() => void printOrphanSweep(), Math.max(5, Number(process.env.PRINT_ORPHAN_SWEEP_SEC) || 60) * 1000);
        (_d = printOrphanTimer.unref) === null || _d === void 0 ? void 0 : _d.call(printOrphanTimer);
    ...
    if (process.env.IDEMPOTENCY_REAPER !== "false") {
        ...
        (_e = idemReaperTimer.unref) === null || _e === void 0 ? void 0 : _e.call(idemReaperTimer);
    ...
    const shutdown = async (signal) => {
        ...
        (_a = forceTimer.unref) === null || _a === void 0 ? void 0 : _a.call(forceTimer);
        try {
