...
async function run() {
    ...
    // Cleanup
    await Promise.all(created.map(id => fetch(`${API_BASE}/booking/${id}`, { method: 'DELETE', headers: { 'X-Restaurant-Id': RESTAURANT_ID } }).catch(() => { })));
...
//# sourceMappingURL=capacity_threshold.js.map